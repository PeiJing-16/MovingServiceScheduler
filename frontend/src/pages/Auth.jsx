          ...
          <div className="w-1/2 bg-[#C1D8F0] p-8 flex flex-col justify-center">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <input
                ...
                className="w-full p-3 rounded-xl bg-[#F3FAFF] drop-shadow-lg border-2 border-[#F3FAFF] focus:outline-none focus:border-[#93A9C0]"
              />
              <button type="submit" className="w-full bg-[#F3FAFF] rounded-xl drop-shadow-lg hover:bg-[#93A9C0] text-black font-bold py-3 rounded-lg transition">
                Login
              </button>
          ...
          <div className="w-1/2 bg-white p-8 flex flex-col justify-center">
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <input
                ...
                className="w-full p-3 rounded-xl bg-[#C1D8F0] drop-shadow-lg border-2 border-[#C1D8F0] focus:outline-none focus:border-[#93A9C0]"
              />
              <button type="submit" className="w-full bg-[#C1D8F0] rounded-xl drop-shadow-lg hover:bg-[#93A9C0] text-black font-bold py-3 rounded-lg transition">
                Register
              </button>
            </form>
          </div>
